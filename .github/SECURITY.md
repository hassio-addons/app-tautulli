...
[**Report a vulnerability**](https://github.com/hassio-addons/app-tautulli/security/advisories/new)
...
- Issues in Tautulli itself; please report those directly to the
  [Tautulli project](https://github.com/Tautulli/Tautulli/security/policy).
- Issues that require an already compromised Home Assistant instance, or
  access to the Supervisor, to exploit.

## Scope

This security policy covers the Tautulli app for Home Assistant and its
